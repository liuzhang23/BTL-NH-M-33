...
class EN_Student:public EN_Person{
	...
	public:
		...
		void ExportFile();
		void Edit();
		EN_Student Search2(int l, int r, int x); 
};
...
//EN_Student EN_Student::Search2(int l, int r, int x){
//	if (r >= l) {
//    int mid = l + (r - l) / 2;
//    if (STD[mid] == x)
//      return STD[mid];
		...
		switch (luachon){
			...
			case 2:
				...
				if(check == true){
					...
					cout<<"\n\tNhap lua chon cua ban: "; cin>>Language;
					while(Language != 1 && Language != 2){
						cout<<"Vui long nhap lai: "; cin>>Language;
					}
					switch(Language){
						case 1:
							check = false;
